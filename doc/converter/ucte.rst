...
pandapower functionality allows to convert grid data from **UCTE** data exchange format for load flow and three phase short circuit studies (UCTE-DEF) to pandapower.
