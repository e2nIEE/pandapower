...
.. note:: If you cannot plot using matplotlib and Anaconda in Julia, add the environment variable :code:`QT_PLUGIN_PATH` with value e.g. :code:`"C:\Anaconda3\Library\plugins"` to your system path.
