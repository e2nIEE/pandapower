...
extensions = ['sphinx.ext.intersphinx', 'sphinx.ext.mathjax', 'sphinx.ext.autodoc', 'numpydoc',
              'sphinx.ext.autosummary', 'sphinxcontrib.napoleon'] #sphinx.ext.mathjax and sphinx.ext.imgmath don't comply with each other anymore., pngmath will be replaced by imgmath in new sphinx version
...
latex_documents = [
  ('latex_index', 'pandapower.tex', u'pandapower Documentation', 
   'Fraunhofer IWES\\\ Universit\\"{a}t Kassel', 'manual'),
]
...
man_pages = [
    ('index', 'jsonpy', u'jsonpy Documentation',
     ['Fraunhofer IWES', 'Kassel University'], 1)
]
...
texinfo_documents = [
  ('index', 'jsonpy', u'jsonpy Documentation',
   ['Fraunhofer IWES', 'Kassel University'], 'jsonpy', 'One line description of project.',
   'Miscellaneous'),
]
