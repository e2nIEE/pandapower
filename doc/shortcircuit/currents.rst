...
Note: `pandapower` currently implements only three-phase (symmetrical) and two-phase (asymmetrical) faults. Single-phase fault and two-phase fault with earthing are not yet available.
