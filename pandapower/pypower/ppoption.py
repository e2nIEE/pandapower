...
4 - Gauss Seidel""",
    ...
    ("pf_max_it_fd", 30, "maximum number of iterations for fast decoupled method"),
    ("pf_max_it_gs", 1000, "maximum number of iterations for Gauss-Seidel method"),
    ("enforce_q_lims", False, "enforce gen reactive power limits, at expense of |V|"),
    (
        "pf_dc",
        False,
...
step-controlled primal/dual interior point method""",
    ...
    (
        "opf_flow_lim",
        0,
        """qty to limit for branch flow constraints:
...
(same options for OUT_LINE_LIM, OUT_PG_LIM, OUT_QG_LIM)""",
    ...
    (
        "return_raw_der",
        0,
        """return constraint and derivative info
...
Primal-Dual Interior Points Methods""",
    ...
    (
        "pdipm_comptol",
        1e-6,
        """complementary condition (inequality)
...
Primal-Dual Interior Points Methods""",
    ...
    (
        "scpdipm_red_it",
        20,
        """maximum number of reductions per iteration
