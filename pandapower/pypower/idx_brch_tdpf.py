...
TDPF = (
    start + 0
)  # bool flag (True or False) of whether the branch must be considered in the TDPF power flow
BR_R_REF_OHM_PER_KM = (
    start + 1
)  # reference R is needed because BR_R in ppc can already be adjusted by temperature
...
WIND_ANGLE_DEGREE = (
    start + 10
)  # Angle of attack, angle between wind direction and conductor
