...
schema = pa.DataFrameSchema(
    {
        ...
        "max_q_mvar": pa.Column(float, description="maximum reactive power of the generator [MVAr]"),
        "min_q_mvar": pa.Column(float, description="minimum reactive power of the generator [MVAr]"),
        ...
        "vn_kv": pa.Column(float, description="rated voltage of the generator"),
        "xdss_pu": pa.Column(float, pa.Check.gt(0), description="subtransient generator reactance in per unit"),
        "rdss_ohm": pa.Column(float, pa.Check.gt(0), description="subtransient generator resistence in ohm"),
        "cos_phi": pa.Column(float, pa.Check.se(1), description="rated generator cosine phi"),
        "in_service": pa.Column(bool, description="specifies if the generator is in service"),
        "power_station_trafo": pa.Column(int, description="index of the power station trafo (short-circuit relevant)"),
