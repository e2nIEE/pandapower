...
schema = pa.DataFrameSchema(
    {
        ...
        "pl_dc_mw": pa.Column(float, description="no-load losses of the VSC on the DC side for the shunt R representing the no load losses"),
        "control_mode_ac": pa.Column(str,pa.Check.isin(["vm_pu", "q_mvar", "slack"]), description="the control mode of the AC side of the VSC"),
        "control_value_ac": pa.Column(float, description="the value of the controlled parameter at the ac bus"),
        "control_mode_dc": pa.Column(str, pa.Check.isin(["vm_pu", "p_mw",]), description="“the control mode of the dc side of the VSC"),
