...
vsc_stacked_schema = pa.DataFrameSchema(
    {
        "name": pa.Column(pd.StringDtype, nullable=True, required=False, description="name of the vsc_stacked"),
        "bus": pa.Column(
            int,
            pa.Check.ge(0),
            description="index of ac bus of the ac side of the vsc_stacked",
            metadata={"foreign_key": "bus"},
        ),
        "bus_dc_plus": pa.Column(
            int,
            pa.Check.ge(0),
            description="index of dc bus of the plus dc side of the vsc_stacked",
            metadata={"foreign_key": "bus_dc"},
        ),
        "bus_dc_minus": pa.Column(
            int,
            pa.Check.ge(0),
            description="index of dc bus of the minus dc side of the vsc_stacked",
            metadata={"foreign_key": "bus_dc"},
        ),
        ...
        "control_mode_dc": pa.Column(
            ...
            description="the control mode of the dc side of the vsc_stacked",
            metadata={"default": "p_mw"},
        ),
...
res_vsc_stacked_schema = pa.DataFrameSchema(
    {
        "p_mw": pa.Column(float, nullable=True, description="total active power consumption of vsc_stacked [MW]"),
        "q_mvar": pa.Column(float, nullable=True, description="total reactive power consumption of vsc_stacked [MVAr]"),
        ...
        "vm_internal_pu": pa.Column(float, nullable=True, description="voltage magnitude at vsc_stacked ac bus [pu]"),
        "vm_internal_degree": pa.Column(
            float, nullable=True, description="voltage angle at vsc_stacked ac bus [degree]"
        ),
        "vm_pu": pa.Column(float, nullable=True, description="active power of the plus side of the vsc_stacked [MW]"),
        "va_degree": pa.Column(float, nullable=True, description="active power of the minus side of vsc_stacked [MW]"),
        "vm_internal_dc_pu_p": pa.Column(
            float, nullable=True, description="voltage angle at the plus vsc_stacked ac bus [pu]"
        ),
        "vm_internal_dc_pu_m": pa.Column(
            float, nullable=True, description="voltage angle at the minus vsc_stacked ac bus [pu]"
        ),
        "vm_dc_pu_p": pa.Column(
            float, nullable=True, description="voltage magnitude at the plus vsc_stacked ac bus [pu]"
        ),
        "vm_dc_pu_m": pa.Column(
