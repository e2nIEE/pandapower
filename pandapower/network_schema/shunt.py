...
schema = pa.DataFrameSchema(
    {
        ...
        "step": pa.Column(int, pa.Check.ge(1), description="step position of the shunt with which power values are multiplied"),
        ...
        "step_dependency_table": pa.Column(bool, description="whether the shunt parameters (q_mvar, p_mw) are adjusted dependent on the step of the shunt"),
        "id_characteristic_table": pa.Column(int, pa.Check.ge(0), description="references the id_characteristic index from the shunt_characteristic_table")
    },
    strict=False,
)
