...
from pandapower.network_schema.trafo import trafo_schema, res_trafo_schema, res_trafo_3ph_schema, res_trafo_sc_schema
from pandapower.network_schema.trafo3w import trafo3w_schema, res_trafo3w_schema, res_trafo3w_sc_schema
