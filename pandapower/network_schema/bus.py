...
schema = pa.DataFrameSchema(  # in methodcall but not parameter docu: geodata, coords
    {
        ...
        "zone": pa.Column(str, nullable=True, description="can be used to group buses, for example network groups / regions"),
        "max_vm_pu": pa.Column(float, pa.Check.gt(0), required=False, description="Maximum voltage", metadata={'opf':True}),
        "min_vm_pu": pa.Column(float, pa.Check.gt(0), required=False, description="Minimum voltage", metadata={'opf':True}),
