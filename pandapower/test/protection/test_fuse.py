...
def test_calc_prot_times_pp_scenario():
    ...
    assert protection_times.trip_melt.at[0], 'trip_melt for switch 4 should be True in pp scenario'
...
def test_has_tripped():
    ...
    Fuse(net=net, switch_index=0, fuse_type="HV 63A")
    net.protection.at[0, "object"].tripped = True
    assert net.protection.at[0, "object"].has_tripped(), '.has_tripped() should equal True'
...
def fuse_test_net3():
    ...
    # define load
    create_load(net, bus=4, p_mw=0.1, q_mvar=0, sn_mva=.1,
...
def fuse_test_net2():
    ...
    # define load
    create_load(net, bus=3, p_mw=0.1, q_mvar=0, sn_mva=.1,
                name=None, scaling=1., index=0)
...
def fuse_test_net4():
    ...
    # define load
    create_loads(net, buses=[4, 8], p_mw=[0.1, 0.05], q_mvar=0, name=None,
                 index=[0, 1])
