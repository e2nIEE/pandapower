...
from pandapower.create import create_empty_network, create_bus_dc, create_line_dc_from_parameters
...
class TestLineDcOptionalFields:
    ...
    def test_valid_optional_values(self, parameter, valid_value):
        """Test: valid optional values are accepted (including null values for non-group columns)"""
        net = create_empty_network()
        b0 = create_bus_dc(net, 0.4)
        b1 = create_bus_dc(net, 0.4)
...
class TestLineDcForeignKey:
    ...
    def test_invalid_from_bus_dc_index(self):
        """Test: from_bus_dc must reference existing bus_dc indices"""
        net = create_empty_network()
        b0 = create_bus_dc(net, 0.4)
        b1 = create_bus_dc(net, 0.4)
