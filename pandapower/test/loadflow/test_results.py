...
# todo create new test for new tap_characteristic_table logic
# commented out due to new logic on characteristics
# def test_tap_dependent_impedance(result_test_network):
#     net = result_test_network
#
#     # first, basic example with piecewise linear characteristic
#      characteristic_vk = pp.control.Characteristic.from_points(
#          net, ((net.trafo.at[0, 'tap_min'], 0.9 * net.trafo.at[0, 'vk_percent']),
#          (net.trafo.at[0, 'tap_neutral'], net.trafo.at[0, 'vk_percent']),
#          (net.trafo.at[0, 'tap_max'], 1.1 * net.trafo.at[0, 'vk_percent'])))
#     characteristic_vkr = pp.control.Characteristic.from_points(
#          net, ((net.trafo.at[0, 'tap_min'], 0.9 * net.trafo.at[0, 'vkr_percent']),
