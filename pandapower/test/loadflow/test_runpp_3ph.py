...
def test_4bus_network():
    ...
    pp.create_line_from_parameters(net, from_bus = busn, to_bus = busk, length_km = 1.0, r0_ohm_per_km = .1005, x0_ohm_per_km = 0.4900884
                             , c0_nf_per_km=  200.5, max_i_ka = 0.89
                             , r_ohm_per_km= .0251, x_ohm_per_km = 0.1225221
                             , c_nf_per_km = 210)
    pp.create_line_from_parameters(net, from_bus = busk, to_bus = busm, length_km = 1.0, r0_ohm_per_km= 0.0848, x0_ohm_per_km= 0.4649556, c0_nf_per_km=\
        230.6,   max_i_ka= 0.963, r_ohm_per_km= 0.0212, x_ohm_per_km= 0.1162389,
                 c_nf_per_km=  230)
    pp.create_line_from_parameters(net, from_bus = busk, to_bus = busp, length_km = 1.0, r0_ohm_per_km = .3048, x0_ohm_per_km = 0.6031856, 
