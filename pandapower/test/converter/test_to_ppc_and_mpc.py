...
@pytest.mark.parametrize("pandapower_function", [case4gs, case6ww, case30, case39])
def test_to_ppc_and_mpc(pandapower_function):
    # pypower cases to validate
    # get pypower grids with results
    ppc_net = get_testgrids("pypower_cases", f"{pandapower_function.__name__}.json")
