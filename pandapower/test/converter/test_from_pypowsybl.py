...
from pypowsybl_converter import PyPowSyBlConverter

def _create_powsybl_ieee_network(pyp, factory_name: str) -> Any:
...
def case_ieee9(pyp) -> Any:
    return _create_powsybl_ieee_network(pyp, "create_ieee9")

def case_ieee14(pyp) -> Any:
    return _create_powsybl_ieee_network(pyp, "create_ieee14")

def case_ieee118(pyp) -> Any:
    return _create_powsybl_ieee_network(pyp, "create_ieee118")

def case_custom_1(pyp) -> Any:
    net = pyp.network.create_empty()

    net.create_substations(id = ["S1"], name = ["Substation 1"])

    net.create_voltage_levels(id = ["10 kV"], substation_id = ["S1"], topology_kind = ["BUS_BREAKER"], nominal_v = [10.0])
    net.create_voltage_levels(id = ["0.4 kV"], substation_id = ["S1"], topology_kind = ["BUS_BREAKER"], nominal_v = [0.4])

    net.create_buses(id = ["mv_bus"], voltage_level_id = ["10 kV"])
    net.create_buses(id = ["lv_bus"], voltage_level_id = ["0.4 kV"])

    net.create_buses(id = ["low2", "low3", "low4", "low5", "low6"], voltage_level_id = ["0.4 kV"] * 5)

    net.create_generators(id = 'grid', voltage_level_id = '10 kV', bus_id = 'mv_bus', min_p = -1, max_p = 1.0, target_p = 0.08, voltage_regulator_on = True, target_v = 10)

    net.create_2_windings_transformers(id = 'transformer', voltage_level1_id = '10 kV',
                                        bus1_id = 'mv_bus', voltage_level2_id = '0.4 kV', bus2_id = 'lv_bus',
                                        b = 0, g = 0, r = 0.01, x = 0.04, rated_u2 = 0.4, rated_u1 = 10.0, rated_s = 0.25)
    
    r = 0.01
    x = 0.005
    net.create_lines(id = 'line0', voltage_level1_id = '0.4 kV', bus1_id = 'lv_bus', 
                    voltage_level2_id = '0.4 kV', bus2_id = 'low2',
                    b1 = 1e-6, b2 = 1e-6, g1 = 0, g2 = 0, r = r, x = x)
    net.create_lines(id = 'line1', voltage_level1_id = '0.4 kV', bus1_id = 'low2', 
                    voltage_level2_id = '0.4 kV', bus2_id = 'low3',
                    b1 = 1e-6, b2 = 1e-6, g1 = 0, g2 = 0, r = r, x = x)
    net.create_lines(id = 'line2', voltage_level1_id = '0.4 kV', bus1_id = 'low3', 
                    voltage_level2_id = '0.4 kV', bus2_id = 'low4',
                    b1 = 1e-6, b2 = 1e-6, g1 = 0, g2 = 0, r = r, x = x)
    net.create_lines(id = 'line3', voltage_level1_id = '0.4 kV', bus1_id = 'low4', 
                    voltage_level2_id = '0.4 kV', bus2_id = 'low5',
                    b1 = 1e-6, b2 = 1e-6, g1 = 0, g2 = 0, r = r, x = x)
    net.create_lines(id = 'line4', voltage_level1_id = '0.4 kV', bus1_id = 'low6', 
                    voltage_level2_id = '0.4 kV', bus2_id = 'low5',
                    b1 = 1e-6, b2 = 1e-6, g1 = 0, g2 = 0, r = r, x = x)
    net.create_lines(id = 'line5', voltage_level1_id = '0.4 kV', bus1_id = 'lv_bus', 
                    voltage_level2_id = '0.4 kV', bus2_id = 'low6',
                    b1 = 1e-6, b2 = 1e-6, g1 = 0, g2 = 0, r = r, x = x)
    
    net.create_loads(
        id = "load low3",
        voltage_level_id = "0.4 kV",
        bus_id = "low3",
        p0 = 0.03,
        q0 = 0.01
    )
...
def case_custom_2(pyp) -> Any:
    net = pyp.network.create_empty()

    net.create_substations(id = ["S1"], name = ["Substation 1"])

    net.create_voltage_levels(id = ["10 kV"], substation_id = ["S1"], topology_kind = ["BUS_BREAKER"], nominal_v = [10])

    net.create_buses(id = ["mv_bus1"], voltage_level_id = ["10 kV"])
    net.create_buses(id = ["mv_bus2"], voltage_level_id = ["10 kV"])

    net.create_loads(id = ["test_load"], voltage_level_id = '10 kV', bus_id = 'mv_bus2', p0 = 10, q0 = 3)

    net.create_generators(id = 'grid', voltage_level_id = '10 kV', bus_id = 'mv_bus1', min_p = 0, max_p = 200, target_p = 100, voltage_regulator_on = True, target_v = 10)

    net.create_switches(id = 'switch', voltage_level_id = '10 kV', bus1_id = 'mv_bus1', bus2_id = 'mv_bus2',
                                kind = 'LOAD_BREAK_SWITCH', open = False)
    
    return net

def case_custom_3(pyp) -> Any:
    net = pyp.network.create_empty()

    net.create_substations(id = ["S1"], name = ["Substation 1"])

    net.create_voltage_levels(id = ["110 kV"], substation_id = ["S1"], topology_kind = ["BUS_BREAKER"], nominal_v = [110])
    net.create_voltage_levels(id = ["20 kV"], substation_id = ["S1"], topology_kind = ["BUS_BREAKER"], nominal_v = [20])
    net.create_voltage_levels(id = ["10 kV"], substation_id = ["S1"], topology_kind = ["BUS_BREAKER"], nominal_v = [10])
    ...
    net.create_loads(id = ["test_load"], voltage_level_id = '20 kV', bus_id = 'mv_bus', p0 = 10, q0 = 3)

    net.create_generators(id = 'grid', voltage_level_id = '110 kV', bus_id = 'hv_bus', min_p = 0, max_p = 200, target_p = 100, voltage_regulator_on = True, target_v = 110)

    net.create_3_windings_transformers(id='T-1', rated_u0 = 110, voltage_level1_id='110 kV', bus1_id='hv_bus',
                                        voltage_level2_id='20 kV', bus2_id='mv_bus',
                                        voltage_level3_id='10 kV', bus3_id='lv_bus',
                                        b1=1e-6, g1=1e-6, r1=0.5, x1=10, rated_u1=110, rated_s1=100,
                                        b2=1e-6, g2=1e-6, r2=0.5, x2=10, rated_u2=20, rated_s2=100,
                                        b3=1e-6, g3=1e-6, r3=0.5, x3=10, rated_u3=10, rated_s3=100)
    return net

def case_pp_custom_1(pandapower) -> Any:
    pp = pandapower
    ...
    pp.create_gen(net, bus = mv_busbar, p_mw = 0.08, vm_pu = 1.02, name = "grid", min_p_mw = -1.0, max_p_mw = 1.0, min_q_mvar = -1.0, max_q_mvar = 1.0, slack = True, slack_weight = 1.0)

    pp.create_transformer(net, hv_bus = mv_busbar, lv_bus = lv_busbar, std_type = "0.25 MVA 10/0.4 kV")
    net.trafo.shift_degree = 0

    pp.create_line(net, from_bus = lv_busbar, to_bus = bus_low2, length_km = 0.2, std_type = "NAYY 4x120 SE")
    pp.create_line(net, from_bus = bus_low2, to_bus = bus_low3, length_km = 0.2, std_type = "NAYY 4x120 SE")
    pp.create_line(net, from_bus = bus_low3, to_bus = bus_low4, length_km = 0.2, std_type = "NAYY 4x120 SE")
    pp.create_line(net, from_bus = bus_low4, to_bus = bus_low5, length_km = 0.2, std_type = "NAYY 4x120 SE")
    pp.create_line(net, from_bus = bus_low6, to_bus = bus_low5, length_km = 0.2, std_type = "NAYY 4x120 SE")
    pp.create_line(net, from_bus = lv_busbar, to_bus = bus_low6, length_km = 0.2, std_type = "NAYY 4x120 SE")
...
def _powsybl_loadflow_must_converge(network: Any, pyp_lf: Any, label: str) -> list[Any]:
    ...
    assert all("CONVERGED" in status for status in statuses), (
...
def _get_original_switch_ids(original_network: Any) -> set[str]:
    original_switches = _get_table_or_empty(
        original_network,
        "get_switches"
    )
...
def _original_bus_result_frame(network: Any) -> pd.DataFrame:
    ...
    missing_columns = [column for column in required_columns if column not in buses.columns]
...
def _roundtrip_bus_result_frame(roundtrip_network: Any, pandapower_network: Any) -> pd.DataFrame:
    ...
    if missing_columns:
        pytest.skip(f"pypowsybl roundtrip bus-breaker result columns missing: {missing_columns}")
    ...
    if result.empty:
        pytest.skip("No roundtrip buses could be mapped back to original pandapower bus names")
...
def _assert_same_bus_loadflow_results(
        ...
        roundtrip_network: Any,
        pandapower_network: Any
) -> None:
    ...
    debug = pd.DataFrame({
        "original_v_mag": original_buses["v_mag"],
        "roundtrip_v_mag": roundtrip_buses["v_mag"],
        "delta_v_mag": roundtrip_buses["v_mag"] - original_buses["v_mag"],
        "original_v_angle": original_buses["v_angle"],
        "roundtrip_v_angle": roundtrip_buses["v_angle"],
        "delta_v_angle": roundtrip_buses["v_angle"] - original_buses["v_angle"],
    })

    print("\nDEBUG_BUS_LOADFLOW_ROUNDTRIP")
    ...
    original_angles = original_buses["v_angle"].to_numpy() - original_buses["v_angle"].to_numpy()[0]
    roundtrip_angles = roundtrip_buses["v_angle"].to_numpy() - roundtrip_buses["v_angle"].to_numpy()[0]
...
def _assert_same_pandapower_bus_loadflow_results(
    ...
    debug = pd.DataFrame({
        "original_v_mag": original_buses["v_mag"],
        "pandapower_v_mag": pandapower_buses["v_mag"],
        "delta_v_mag": pandapower_buses["v_mag"] - original_buses["v_mag"],
        "original_v_angle": original_buses["v_angle"],
        "pandapower_v_angle": pandapower_buses["v_angle"],
        "delta_v_angle": pandapower_buses["v_angle"] - original_buses["v_angle"]
    })

    print("\nDEBUG_BUS_LOADFLOW_ORIGINAL_POWSYBL_VS_PANDAPOWER")
    print(debug.to_string())
    ...
    regulated_common_buses = [
        bus_name for bus_name in bus_order
        if bus_name in regulated_bus_names
    ]
    ...
    if regulated_common_buses:
        np.testing.assert_allclose(
            ...
            rtol = 5e-3,
            atol = 1e-2,
            err_msg = "Regulated bus voltage magnitudes differ after powsybl -> pandapower conversion"
        )
    ...
    np.testing.assert_allclose(
        ...
        rtol = 5e-2,
        atol = 1e-1,
        err_msg = "Bus voltage magnitudes differ too much after powsybl -> pandapower conversion"
    )

    original_angles = (
        original_buses["v_angle"].to_numpy()
        - original_buses["v_angle"].to_numpy()[0]
    )
...
def _assert_basic_network_size_is_preserved(
    ...
    cross_voltage_line_ids = _get_cross_voltage_line_ids_from_pandapower(pandapower_network)

    checks = [
        (
            "bus-breaker buses",
            lambda network: network.get_bus_breaker_view_buses(),
            0
        ),
        (
            "loads",
            lambda network: network.get_loads(),
            0
        ),
        (
            "generators",
            lambda network: network.get_generators(),
            0
        ),
        (
            "lines",
...
def _get_first_existing_column(frame: pd.DataFrame, candidates: list[str]) -> str | None:
...
def _require_first_existing_column(frame: pd.DataFrame, candidates: list[str], component_name: str) -> str:
...
def _assert_close_value(
    ...
    assert np.isclose(
        ...
        f"{label} mismatch: "
        f"expected powsybl = {expected}, pandapower = {actual}"
    )
...
def _assert_converted_loads_match_powsybl(original_network: Any, pandapower_network: Any) -> None:
...
def _assert_converted_generators_match_powsybl(original_network: Any, pandapower_network: Any) -> None:
...
def _assert_converted_lines_match_powsybl(
    ...
    original_lines = _get_table_or_empty(
        original_network,
        "get_lines"
    )
    ...
    bus1_column = _get_first_existing_column(
        original_lines,
        ["bus_breaker_bus1_id", "bus1_bus_id", "bus1_name"]
    )

    bus2_column = _get_first_existing_column(
        original_lines,
        ["bus_breaker_bus2_id", "bus2_bus_id", "bus2_name"]
    )

    frequency_hz = _pandapower_frequency_hz(pandapower_network)

    for line_id, pyp_line in original_lines.iterrows():
        matching_pp_line = pp_lines[
            pp_lines["name"].astype(str) == str(line_id)
        ]
        ...
        if not matching_pp_line.empty:
            ...
            _assert_finite_positive(
                length_km,
                f"Line {line_id!r} has invalid length_km: {length_km}"
            )
            ...
            if g1_column is not None and g2_column is not None and "g_us_per_km" in pp_lines.columns:
            ...
            if b1_column is not None and b2_column is not None and "c_nf_per_km" in pp_lines.columns:
                expected_b_s = float(pyp_line[b1_column]) + float(pyp_line[b2_column])
                actual_b_s = (
                    2.0 * np.pi * frequency_hz * float(pp_line["c_nf_per_km"]) * 1e-9 * length_km * parallel
                )
            ...
            if g1_column is not None and g2_column is not None and "powsybl_g_total_s" in pp_impedance.index:
                expected_g_s = float(pyp_line[g1_column]) + float(pyp_line[g2_column])
            ...
            if b1_column is not None and b2_column is not None and "powsybl_b_total_s" in pp_impedance.index:
                expected_b_s = float(pyp_line[b1_column]) + float(pyp_line[b2_column])
...
def _assert_converted_2w_transformers_match_powsybl(
    ...
    for trafo_id, pyp_trafo in original_trafos.iterrows():
        matching_pp_trafo = pp_trafos[
            pp_trafos["name"].astype(str) == str(trafo_id)
        ]
        ...
        for column in [
            ...
            assert np.isfinite(float(pp_trafo[column])), (
                f"2W transformer {trafo_id!r} has invalid {column}:"
                f"{pp_trafo[column]}"
            )
        ...
        if rated_u1_column is not None and rated_u2_column is not None:
            expected_voltages = sorted(
                [
                    float(pyp_trafo[rated_u1_column]),
                    float(pyp_trafo[rated_u2_column])
                ],
                reverse = True
            )
        ...
        if (
            ...
            expected_vk_percent = (100.0 * np.hypot(float(pyp_trafo[r_column]), float(pyp_trafo[x_column]))) / z_base_ohm
        ...
        if (
            ...
            y_no_load_pu = complex(
                float(pyp_trafo[g_column]),
                float(pyp_trafo[b_column])
            ) / y_base_s
...
def _assert_converted_3w_transformers_match_powsybl(
    ...
    for trafo_id, pyp_trafo in original_trafos.iterrows():
        ...
        for column in [
            ...
            assert np.isfinite(float(pp_trafo[column])), (
                f"3W transformer {trafo_id!r} has invalid {column}: "
                f"{pp_trafo[column]}"
            )
        ...
        if all(column is not None for column in rated_u_columns):
            expected_voltages = sorted(
                [float(pyp_trafo[column]) for column in rated_u_columns],
                reverse = True
            )
...
def _assert_converted_switches_match_powsybl(
    ...
    for switch_index, pp_switch in pp_switches.iterrows():
        assert int(pp_switch["bus"]) in pandapower_network.bus.index, (
            f"Switch {switch_index} is connected to an invalid bus: "
            f"{pp_switch['bus']}"
        )

        assert pp_switch["et"] in {"b"}, (
...
def _assert_roundtrip_bool_columns_equal(
    ...
    for column in columns:
        ...
        original_values = original_table[column].map(
            lambda value: _to_test_bool(value)
        )

        roundtrip_values = roundtrip_table[column].map(
            lambda value: _to_test_bool(value)
        )
...
def _assert_roundtrip_loads_match_powsybl(original_network: Any, roundtrip_network: Any) -> None:
    original_loads = _get_table_or_empty(
        original_network,
        "get_loads"
    )

    roundtrip_loads = _get_table_or_empty(
        roundtrip_network,
        "get_loads"
    )
...
def _assert_roundtrip_generators_match_powsybl(original_network: Any, roundtrip_network: Any) -> None:
    original_generators = _get_table_or_empty(
        original_network,
        "get_generators"
    )

    roundtrip_generators = _get_table_or_empty(
        roundtrip_network,
        "get_generators"
    )
...
def _assert_roundtrip_lines_match_powsybl(original_network: Any, roundtrip_network: Any, pandapower_network: Any) -> None:
    ...
    _assert_roundtrip_line_shunt_sums_match(
        original_lines,
        roundtrip_lines
    )
...
def _assert_roundtrip_3w_transformers_match_powsybl(original_network: Any, roundtrip_network: Any) -> None:
    original_trafos = _get_table_or_empty(
        original_network,
        "get_3_windings_transformers"
    )
    ...
    if not original_trafos.empty and roundtrip_trafos.empty:
        print(
            "\nINFO: 3W transformers roundtrip comparison is not executed because "
...
def _assert_roundtrip_switches_match_powsybl(original_network: Any, roundtrip_network: Any) -> None:
    original_switches = _get_table_or_empty(
        original_network,
        "get_switches"
    )

    roundtrip_switches = _get_table_or_empty(
        roundtrip_network,
        "get_switches"
    )
    ...
    if not original_switches.empty and roundtrip_switches.empty:
        print(
            "\nINFO: Switch roundtrip comparison is not executed because "
            "pypowsybl.convert_from_pandapower does not recreate pandapower "
...
def _assert_roundtrip_static_values_match_powsybl(original_network: Any, roundtrip_network: Any, pandapower_network: Any) -> None:
    _assert_roundtrip_loads_match_powsybl(
        original_network,
        roundtrip_network
    )

    _assert_roundtrip_generators_match_powsybl(
        original_network,
        roundtrip_network
    )
    ...
    _assert_roundtrip_2w_transformers_match_powsybl(
        original_network,
        roundtrip_network
    )

    _assert_roundtrip_3w_transformers_match_powsybl(
        original_network,
        roundtrip_network
    )

    _assert_roundtrip_switches_match_powsybl(
        original_network,
        roundtrip_network
    )
...
def _run_conversion_roundtrip_cycle(
    ...
    _powsybl_loadflow_must_converge(
        original_network,
        pyp_lf,
        label = f"original {case_name}"
    )

    xiidm_path = _save_network_as_xiidm(
        original_network,
        tmp_path / f"{case_name}.xiidm"
    )
    ...
    assert bool(pandapower_network.converged) is True

    _assert_same_pandapower_bus_loadflow_results(
        original_network,
        pandapower_network
    )

    _assert_converted_loads_match_powsybl(
        original_network,
        pandapower_network
    )

    _assert_converted_generators_match_powsybl(
        original_network,
        pandapower_network
    )

    _assert_converted_lines_match_powsybl(
        original_network,
        pandapower_network
    )
    ...
    _assert_converted_switches_match_powsybl(
        original_network,
        pandapower_network
    )
    ...
    if original_switch_ids:
        print(
            ...
            f"Skipped final roundtrip bus comparison for switches: {sorted(original_switch_ids)}"
        )
        return
    ...
    if original_3w_trafo_ids:
        print(
            ...
            f"Skipped final roundtrip bus comparison for 3W transformers: "
            f"{sorted(original_3w_trafo_ids)}"
        )
        return
    ...
    _assert_basic_network_size_is_preserved(original_network, roundtrip_network, pandapower_network)
    ...
    if cross_voltage_line_ids:
        print(
            ...
            f"Excluded lines: {sorted(cross_voltage_line_ids)}"
        )
        return
...
def _assert_same_pandapower_network_results(original_pp_net: Any, roundtrip_pp_net: Any) -> None:
    ...
    original_v_mag = (
        original_pp_net.res_bus["vm_pu"].to_numpy(dtype = float)
        * original_pp_net.bus["vn_kv"].to_numpy(dtype = float)
    )

    roundtrip_v_mag = (
        roundtrip_pp_net.res_bus["vm_pu"].to_numpy(dtype = float)
    ...
    np.testing.assert_allclose(
        ...
        rtol = 5e-2,
        atol = 1e-1,
        err_msg = "Pandapower bus voltage magnitudes differ after pandapower -> powsybl -> pandapower roundtrip"
    )
    ...
    np.testing.assert_allclose(
        ...
        rtol = 5e-2,
        atol = 1.0,
        err_msg = "Pandapower bus voltage angles differ after pandapower -> powsybl -> pandapower roundtrip"
    )
...
def _run_conversion_pandapower_cycle(
    ...
    assert bool(original_pp_net.converged) is True
    ...
    _powsybl_loadflow_must_converge(
        pyp_network,
        pyp_lf,
        label = f"powsybl converted from pandapower {case_name}"
    )

    xiidm_path = _save_network_as_xiidm(
        pyp_network,
        tmp_path / f"{case_name}_from_pandapower.xiidm"
    )
    ...
    assert bool(roundtrip_pp_net.converged) is True

    _assert_same_pandapower_network_results(
        original_pp_net,
        roundtrip_pp_net
    )
