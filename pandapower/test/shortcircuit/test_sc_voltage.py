...
def test_voltage_sgen():
    net = simple_grid()
    create_sgen(net, 1, sn_mva=200.0, p_mw=0, k=1.3)
    ...
    assert np.allclose(
        net.res_line_sc.loc[:, "ikss_ka"], [0.460706, 1.825315], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "p_from_mw"], [5.019259, 14.843061], atol=1e-5, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "q_from_mvar"], [10.701325, 23.389066], atol=1e-5, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "p_to_mw"], [-3.810707, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "q_to_mvar"], [-5.862024, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "vm_from_pu"], [0.134660, 0.079654], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "va_from_degree"],
        [-2.919632, -10.818133],
        atol=1e-6,
        rtol=0,
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "vm_to_pu"], [0.079654, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "va_to_degree"], [-10.818133, 0], atol=1e-6, rtol=0
    )
    ...
    assert np.allclose(
        net.res_line_sc.loc[:, "ikss_ka"], [0.495930, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "p_from_mw"], [1.400422, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "q_from_mvar"], [5.607589, 0], atol=1e-6, rtol=0
    )
    ...
    assert np.allclose(
        net.res_line_sc.loc[:, "vm_from_pu"], [0.06117, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "va_from_degree"], [7.348078, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(net.res_line_sc.loc[:, "vm_to_pu"], [0, 0], atol=1e-6, rtol=0)
    assert np.allclose(
        net.res_line_sc.loc[:, "va_to_degree"], [0, 0], atol=1e-6, rtol=0
    )
...
def test_voltage_gen():
    ...
    create_gen(
        ...
        vn_kv=110,
        xdss_pu=0.14,
        rdss_ohm=0.00001653 * z_base_ohm,
        cos_phi=0.85,
        pg_percent=0,
    )
    calc_sc(net, case="max", ip=True, branch_results=True, bus=2)
    ...
    assert np.allclose(
        net.res_line_sc.loc[:, "ikss_ka"], [0.428409, 3.879550], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "p_from_mw"], [11.853270, 67.051803], atol=1e-5, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "q_from_mvar"],
        [12.794845, 105.657389],
        atol=1e-5,
        rtol=0,
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "p_to_mw"], [-10.808227, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "q_to_mvar"], [-8.610268, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "vm_from_pu"], [0.213685, 0.169299], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "va_from_degree"],
        [-17.016990, -25.662429],
    ...
    assert np.allclose(
        net.res_line_sc.loc[:, "vm_to_pu"], [0.169299, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "va_to_degree"], [-25.662429, 0], atol=1e-6, rtol=0
    )
...
def test_voltage_simple():
    ...
    assert np.allclose(
        net.res_line_sc.loc[:, "ikss_ka"], [0.486532, 0.486532], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "p_from_mw"], [2.4024, 1.054556], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "q_from_mvar"], [7.058781, 1.661725], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "p_to_mw"], [-1.054556, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "q_to_mvar"], [-1.661725, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "vm_from_pu"], [0.080439, 0.021232], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "va_from_degree"],
        [2.786108, -10.818133],
    ...
    assert np.allclose(
        net.res_line_sc.loc[:, "vm_to_pu"], [0.021232, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "va_to_degree"], [-10.818133, 0], atol=1e-6, rtol=0
    )
    ...
    assert np.allclose(
        net.res_line_sc.loc[:, "ikss_ka"], [0.49593, 0], atol=1e-6, rtol=0
    )
    assert np.allclose(
        net.res_line_sc.loc[:, "p_from_mw"], [1.400422, 0], atol=1e-6, rtol=0
    )
...
def test_voltage_very_simple():
    ...
    assert np.isclose(
        net.res_line_sc.at[0, "va_from_degree"], 7.348078, atol=1e-6, rtol=0
    )
