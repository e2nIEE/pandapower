...
if __name__ == "__main__":
    ...
    '''if lv_tol_percent == 6:
        df_bus.to_json("df_bus_saved_6.json", orient="records", indent=2)
        df_branch.to_json("df_branch_saved_6.json", orient="records", indent=2)
        df_bus_simple.to_json("df_bus_simple_saved_6.json", orient="records", indent=2)
        df_branch_simple.to_json("df_branch_simple_saved_6.json", orient="records", indent=2)'''

    if lv_tol_percent == 10:
        df_bus.to_json("df_bus_saved_10.json", orient="records", indent=2)
        df_branch.to_json("df_branch_saved_10.json", orient="records", indent=2)
        df_bus_simple.to_json("df_bus_simple_saved_10.json", orient="records", indent=2)
        df_branch_simple.to_json("df_branch_simple_saved_10.json", orient="records", indent=2)
