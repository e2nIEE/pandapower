...
def test_kb_extrem_landnetz_freileitung():
    pd_net = kb_extrem_landnetz_freileitung(p_load_mw=0.002, q_load_mvar=0.001)
...
def test_kb_extrem_landnetz_kabel():
    pd_net = kb_extrem_landnetz_kabel(p_load_mw=0.002, q_load_mvar=0.001)
...
def test_kb_extrem_landnetz_freileitung_trafo():
    pd_net = kb_extrem_landnetz_freileitung_trafo(p_load_mw=0.002, q_load_mvar=0.001)
