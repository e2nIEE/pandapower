...
def test_dickert_lv_networks(net_data):
    net = create_dickert_lv_network(net_data[0], net_data[1], net_data[2], net_data[3])
    assert net.bus.shape[0] == net_data[4] + 2
    runpp(net)
