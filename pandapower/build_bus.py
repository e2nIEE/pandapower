...
def _fill_auxiliary_buses(net, ppc, bus_lookup, element, bus_column, aux):
    ...
    if  isinstance(net._options["init_vm_pu"], str) and net._options["init_vm_pu"] == "results":
    ...
    if isinstance(net._options["init_vm_pu"], str) and net._options["init_va_degree"] == "results":
