...
|------------------------------|----------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **IKSS**                     | Initial symmetrical short-circuit current    | RMS value of the symmetrical component of short-circuit current (in kA) immediately after fault inception; no decay considered yet.                                                             | <details><summary>`I_kss = (c * U_n) / (sqrt(3) * Z)`</summary><ul><li>`c` – voltage factor</li><li>`U_n` – nominal phase-to-phase voltage</li><li>`Z` – total short-circuit impedance</li></ul></details>                 |
| **IKSSC**                    | Current source contribution                  | Contribution from rotating machines and inverter-based sources (modeled as current sources) to the short-circuit current.                                                                       | <details><summary>`I_kssc = sum(I_source)`</summary><ul><li>`I_source` – contribution from each generator or inverter</li></ul></details>                                                                                  |
| **IKSSV**                    | Voltage source contribution                  | Contribution from upstream grid voltage source (external grid). The difference between total and current-source contributions.                                                                  | <details><summary>`I_kssv = I_kss - I_kssc`</summary><ul><li>`I_kss` – total initial symmetrical short-circuit current</li><li>`I_kssc` – current source contribution</li></ul></details>                                  |
| **SKSS**                     | Initial short-circuit power                  | Short-circuit apparent power (in MVA) immediately after fault inception.                                                                                                                        | <details><summary>`S_kss = sqrt(3) * U_n * I_kss`</summary><ul><li>`U_n` – nominal voltage</li><li>`I_kss` – initial symmetrical short-circuit current</li></ul></details>                                                 |
| **Ip**                       | Peak short-circuit current                   | Highest instantaneous short-circuit current during fault.                                                                                                                                       | <details><summary>`I_p = kappa * sqrt(2) * I_kss`</summary><ul><li>`kappa` – peak factor (depends on R/X ratio)</li><li>`I_kss` – initial symmetrical short-circuit current</li></ul></details>                            |
| **Ith**                      | Thermal equivalent short-circuit current     | Current used to evaluate thermal stress on equipment during fault.                                                                                                                              | <details><summary>`I_th = I_kss * sqrt(t_k / t_ref)`</summary><ul><li>`I_kss` – initial symmetrical short-circuit current</li><li>`t_k` – fault duration</li><li>`t_ref` – reference time (usually 1s)</li></ul></details> |
| **kappa**                    | Peak factor                                  | Factor to calculate peak current from RMS value; depends on R/X ratio of the grid.                                                                                                              | <details><summary>`kappa = 1.02 + 0.98 * exp(-3 * R / X)`</summary><ul><li>`R` – grid resistance</li><li>`X` – grid reactance</li></ul></details>                                                                          |
...
| **PPC**                      | Pandapower Case                              | Pypower-compatible grid data structure with all elements.                                                                                                                                       |                                                                                                                                                                                                                            |
| **PPCI**                     | Pandapower Case Internal                     |                                                                                                                                                                                                 |                                                                                                                                                                                                                            |
| **Ybus**                     | Bus admittance matrix [Y] of the grid        | Formed from line/transformer admittances and shunt elements.                                                                                                                                    | `Y_bus = sum(element_admittances)`                                                                                                                                                                                         |
...
| **LLL, LL, LG, LLG**         | Fault types in short-circuit analysis        | LLL: Three-phase balanced fault; LL: Line-to-line fault; LG: Single line-to-ground fault; LLG: Double line-to-ground fault.                                                                     |                                                                                                                                                                                                                            |
