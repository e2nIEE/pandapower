...
def create_load_from_cosphi(net, bus, sn_mva, cos_phi, mode, **kwargs):
    ...
    """
    from pandapower.toolbox.general_issues import pq_from_cosphi
...
def create_ward(net, bus, ps_mw, qs_mvar, pz_mw, qz_mvar, name=None, in_service=True, index=None, **kwargs):
    """
