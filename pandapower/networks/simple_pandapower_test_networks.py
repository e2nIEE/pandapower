...
def panda_four_load_branch():
    ...
    busnr1 = create_bus(net, name="bus1", vn_kv=10.0, geodata=(0, 0))
    busnr2 = create_bus(net, name="bus2", vn_kv=0.4, geodata=(0, -1))
    busnr3 = create_bus(net, name="bus3", vn_kv=0.4, geodata=(0, -2))
    busnr4 = create_bus(net, name="bus4", vn_kv=0.4, geodata=(0, -3))
    busnr5 = create_bus(net, name="bus5", vn_kv=0.4, geodata=(0, -4))
    busnr6 = create_bus(net, name="bus6", vn_kv=0.4, geodata=(0, -5))
    ...
    create_line(
        net, busnr2, busnr3, name="line1", length_km=0.05, std_type="NAYY 4x120 SE"
    )
    create_line(
        net, busnr3, busnr4, name="line2", length_km=0.05, std_type="NAYY 4x120 SE"
    )
    create_line(
        net, busnr4, busnr5, name="line3", length_km=0.05, std_type="NAYY 4x120 SE"
    )
    create_line(
        net, busnr5, busnr6, name="line4", length_km=0.05, std_type="NAYY 4x120 SE"
    )
...
def four_loads_with_branches_out():
    ...
    busnr1 = create_bus(net, name="bus1ref", vn_kv=10.0, geodata=(0, 0))
    create_ext_grid(net, busnr1)
    busnr2 = create_bus(net, name="bus2", vn_kv=0.4, geodata=(0, -1))
    create_transformer(net, busnr1, busnr2, std_type="0.25 MVA 10/0.4 kV")
    busnr3 = create_bus(net, name="bus3", vn_kv=0.4, geodata=(0, -2))
    ...
    busnr7 = create_bus(net, name="bus7", vn_kv=0.4, geodata=(1, -3))
    create_line(
        net, busnr3, busnr7, name="line5", length_km=0.05, std_type="NAYY 4x120 SE"
    )
    busnr8 = create_bus(net, name="bus8", vn_kv=0.4, geodata=(1, -4))
    create_line(
        net, busnr4, busnr8, name="line6", length_km=0.05, std_type="NAYY 4x120 SE"
    )
    busnr9 = create_bus(net, name="bus9", vn_kv=0.4, geodata=(1, -5))
    create_line(
        net, busnr5, busnr9, name="line7", length_km=0.05, std_type="NAYY 4x120 SE"
    )
    busnr10 = create_bus(net, name="bus10", vn_kv=0.4, geodata=(1, -6))
    create_line(
        net, busnr6, busnr10, name="line8", length_km=0.05, std_type="NAYY 4x120 SE"
    )
...
def simple_four_bus_system():
    ...
    busnr2 = create_bus(net, name="bus2", vn_kv=0.4, geodata=(0, -1))
    create_transformer(
        net, busnr1, busnr2, name="transformer", std_type="0.25 MVA 10/0.4 kV"
    )
    busnr3 = create_bus(net, name="bus3", vn_kv=0.4, geodata=(0, -2))
    create_line(
        net, busnr2, busnr3, name="line1", length_km=0.50000, std_type="NAYY 4x50 SE"
    )
    busnr4 = create_bus(net, name="bus4", vn_kv=0.4, geodata=(0, -3))
    create_line(
        net, busnr3, busnr4, name="line2", length_km=0.50000, std_type="NAYY 4x50 SE"
    )
