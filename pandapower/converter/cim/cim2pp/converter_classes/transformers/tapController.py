    ...
    def _create_tap_controller(self, input_df: pd.DataFrame, trafo_type: str):
        ...
        for _, row in input_df.loc[input_df['TapChangerControl'].notna()].iterrows():
            ...
            if row['discrete']:
                ...
                DiscreteTapControl(self.cimConverter.net, element_type=trafo_type, element_index=trafo_id, side=side,
                ...
                ContinuousTapControl(self.cimConverter.net, element_type=trafo_type, element_index=trafo_id, side=side,
