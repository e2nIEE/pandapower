...
def extend_pp_net_cim(net: pandapowerNet, override: bool = True) -> pandapowerNet:
    ...
    fill_dict['shunt'][np_str_type] = [sc['t'], 'description', 'id_characteristic_table', 'step_characteristic_table']
    fill_dict['ward'] = dict()
    ...
    fill_dict['trafo3w'][np_str_type] = [sc['t_hv'], sc['t_mv'], sc['t_lv'], sc['pte_id_hv'], sc['pte_id_mv'],
                                         ...
                                         'id_characteristic_table', 'tap_characteristic_table']
