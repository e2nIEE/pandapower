...
def draw_cluster(traces, numb_cluster, on_map=False, map_style='basic', showlegend=True, figsize=1,
    ...
    if _in_ipynb():
        ...
        plot(fig, filename=f'Clusters_{numb_cluster}.html')
    else:
        from plotly.offline import plot as plot
        #plot(fig, filename=filename, auto_open=auto_open)
        plot(fig, filename=f'Clusters_{numb_cluster}.html', auto_open=auto_open)
