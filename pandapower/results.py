...
def verify_results(net, mode="pf"):
    ...
    for element in elements:
        ...
        index_equal = net[element].index.equals(net[res_element].index)
        if res_element not in net or not index_equal:
            if not index_equal and net["_options"]["init_results"] and element == "bus":
