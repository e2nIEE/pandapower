...
def _testfiles_folder():
    return os.path.join(test_path, 'converter', "testfiles")
...
def test_from_ucte(test_case):
    ...
    test/converter/testfiles/test_ucte.pfd file and power factory version 2024 service
    pack 1. The test case are derived from the test cases to
    check the power flow results without any convter, cf
    test/test_files/test_results.pfd and test/loadflow/test_runpp.py.
