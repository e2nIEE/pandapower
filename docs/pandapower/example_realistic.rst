...
.. image:: /pandapower/pics/example_network_busses_hv_detail.png
	:width: 35em
	:alt: alternate Text
	:align: center
...
.. note:: Ward and Extended Ward equivalents can be created the same way. They are a practical representation 
    of adjacent external networks. If there are more than one border bus impedances between all border busses 
...
.. image:: /pandapower/pics/example_network_busses_mv.png
	:width: 30em
	:alt: alternate Text
	:align: center
...
.. image:: /pandapower/pics/example_network_busses_lv.png
	:width: 30em
	:alt: alternate Text
	:align: center
