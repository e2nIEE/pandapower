...
Two busses that are connected with a closed bus-bus switches are fused internally for the loadflow, open bus-bus switches are ignored:
...
This has the following advantages compared to modelling the switch as a small impedance:
    ...
    - less busses in the admittance matrix
