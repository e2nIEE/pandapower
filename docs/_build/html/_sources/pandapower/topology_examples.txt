...
Finding the shortest path between two busses is a good example for that.
...
.. image:: /pandapower/pics/nx_shortest_path.png
	:width: 42em
	:alt: alternate Text
	:align: center

Find disconnected busses
------------------------

With *unsupplied_busses* you can easily find busses that are not connected to an external grid. 
...
.. image:: /pandapower/pics/top_disconnected_busses.png
	:width: 42em
	:alt: alternate Text
	:align: center


Calculate distances between busses
----------------------------------
...
.. image:: /pandapower/pics/top_calc_distance_to_bus.png
	:width: 42em
	:alt: alternate Text
	:align: center

Find connected busses with the same voltage level
--------------------------------------------------
...
rings and ring sections in your network. To achieve that for our example network, the trafo busses needs to
be set as a nogobusses. With *respect_switches = True* you get the ring sections, with *respect_switches = False* the whole ring. 

.. code:: python

	import pandapower.topology as top
	
	mg_ring_sections = top.create_nxgraph(net, nogobusses = [0, 1])
...
.. image:: /pandapower/pics/top_find_ring_sections.png
	:width: 42em
	:alt: alternate Text
	:align: center
...
.. code:: python
	...
	mg_ring = top.create_nxgraph(net, respect_switches = False, nogobusses = [0,1])
...
.. image:: /pandapower/pics/top_find_rings.png
	:width: 42em
	:alt: alternate Text
	:align: center
...
*determine_stubs* lets you identify busses and lines that are stubs. Open switches are being ignored. Busses that you want to exclude should be defined as roots. 
Ext_grid busses are roots by default.
...
.. image:: /pandapower/pics/top_determine_stubs.png
	:width: 42em
	:alt: alternate Text
	:align: center
