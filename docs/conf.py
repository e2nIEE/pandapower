...
copyright = u'2016, Alexander Scheidler, Leon Thurner'
...
htmlhelp_basename = 'pandapowerdoc'
...
latex_documents = [
  ('index', 'jsonpy.tex', u'jsonpy Documentation', 
   ['Leon Thurner', 'Alexander Scheidler'], 'manual'),
]
